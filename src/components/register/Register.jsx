...
async function handleSubmit(){
  ...
  return (
    <div className="h-screen w-screen relative flex overflow-hidden">
      ...
      {/* Background image */}
      <img
           src="https://m.media-amazon.com/images/I/61HfqNFt22L._AC_UF1000,1000_QL80_.jpg"
      ...
      <div
        ...
        style={{ zIndex: 20 }}
      >
        <form className="flex flex-col  gap-6 w-3/4" onSubmit={(e)=>{
          e.preventDefault();
          handleSubmit();
        }
  ...
  <span className="text-white text-sm mt-2">Upload Profile</span>
</div>
          <input type="text"
